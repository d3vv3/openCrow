...
var defaultTools = []ToolDefinition{
	...
	{ID: "create_skill", Name: "create_skill", Description: "Create or overwrite a skill file in the skills folder. The content should be a well-structured Markdown document starting with a # Title, a short description paragraph, and then sections for instructions, examples, etc. The slug becomes the filename (lowercase, hyphens, no spaces).", Source: "builtin", Parameters: []ToolParameter{
		...
		{Name: "content", Type: "string", Description: "Full SKILL.md content in Markdown. Should start with # Title and include a description and instructions.", Required: true},
	}},
